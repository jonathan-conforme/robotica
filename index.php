    ...
    <main class="container">
      <div class="p-4 p-md-5 mb-4 rounded text-body-emphasis bg-body-secondary">
        <div class="col-lg-6 px-0">
          <h6 class="display-4 fst-italic">
            SISTEMA AUTOMATIZADO PARA PUERTAS A BASE DE PANELES SOLARES.
          </h6>
          <p class="lead my-3">
            En la actualidad la domotización es considerada un factor importante
            y necesario en la vida diaria del ser humano ya que permite
            facilitar procesos o tareas reduciendo al mínimo la intervención
            humana. Sin embargo, la mayoría de las viviendas o edificios carecen
            de este privilegio debido a que la implementación de este sistema es
            costosa.
          </p>
          <p class="lead mb-0">
